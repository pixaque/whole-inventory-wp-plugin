...
?>
<div class="wrap">
<div class="wp-list-table widefat fixed striped table-view-list posts" id="wp_wer_pk_blocks_projects_table">
	<table class="wp-list-table widefat fixed striped table-view-list pages">
		<tr >
			...
			<th scope="col" id="project_name" class="manage-column column-title column-primary sortable desc" abbr="<?php echo __('Project Name', 'wer_pk') ?>">
				<a href="admin.php?page=wp_wer_pk_blocks_projects<?php echo isset($_GET['paged']) ? "&paged={$_GET['paged']}" : ""; ?><?php echo isset($_GET['order']) ? $_GET['order'] == "desc" ? "&order=asc" : "&order=desc" : "&order=asc" ?>">
...
?>
		<tr>
			...
			<td><a href="#"><?php echo $result->site_name ?></a></td>
			<td><?php echo $result->site_size ?></td>
			<td><?php echo $result->site_location ?></td>
			<td><?php echo $result->start_date ?></td>
			<td><?php echo $result->status ?></td>
			<td>
				<a href="?page=wp_wer_pk_blocks_projects&project=<?php echo $result->id ?>&action=edit">
					Edit
				</a> |
				<a href="?page=wp_wer_pk_blocks_projects&project=<?php echo $result->id ?>&action=trash">
					Delete
				</a>
			</td>
		</tr>
